...
| ---  | --- | --- | --- | --- | 
|  <img src="https://blognoeliagonz.files.wordpress.com/2019/03/0_vpp28-xhhftjjg9s.png" width="60">  | **esquisse** | `esquisser()` | Drag-n drop-ggplots like Tableau | [Get started w/ `esquisse`](https://cran.r-project.org/web/packages/esquisse/vignettes/get-started.html) |  
