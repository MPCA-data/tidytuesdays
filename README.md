...
| ---  | --- | --- | --- |  
| Jun 16 | [Pear programming](https://github.com/MPCA-data/tidytuesdays/new/master/show-n-tell/exercises) | Where's Waldo? The `waldo` pkg. |  +100 `pts` |  
| Jun 16 | MDH shares - Grouping data frames in a list _()_ | Mapping HUGE Raster layers _(Min)_ |  +100 `pts` |   
