...
| ---  | --- | --- | --- |  
| Jun 23 | [Pear programming challenge!](https://github.com/MPCA-data/tidytuesdays/new/master/show-n-tell/exercises) | [Checking for differences](https://github.com/MPCA-data/tidytuesdays/blob/master/show-n-tell/reading_files/Waldo_Compare_files_Find_differences.Md) The `waldo` pkg. |  +100 `pts` |  
