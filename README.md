...
| ---  | --- | --- | --- |
| May 19 | [More mapping tools in R: With MPCA's Environmental Justice maps](https://github.com/MPCA-data/tidytuesdays) _(Dorian)_| Something surprising _(Mystery guest)_ |  +100 `pts` | 
