...
| ---  | --- | --- | --- |  
| Jun 23 | [Checking for differences](https://github.com/MPCA-data/tidytuesdays/blob/master/show-n-tell/reading_files/Waldo_Compare_files_Find_differences.Md) The `waldo` pkg. | [Pear programming puzzles](https://github.com/MPCA-data/tidytuesdays/new/master/show-n-tell/exercises) |  +100 `pts` |  
