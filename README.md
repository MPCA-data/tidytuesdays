...
| **Sep 15** | **:star: Group [`swirl`](https://github.com/swirldev/swirl_courses#install-and-run-a-course-automatically-from-swirl) `Back to Basics` and more** | Barbara | +300 `pts`|
